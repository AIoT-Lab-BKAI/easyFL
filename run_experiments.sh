CUDA_VISIBLE_DEVICES=1,2 python main.py --task mnist_cnum10_dist1_skew0.8_seed0 --model cnn --algorithm fedjsrl+k --num_rounds 100 --num_epochs 5 --learning_rate 0.001 --proportion 1 --batch_size 10 --eval_interval 1 --num_threads_per_gpu 1  --num_gpus 2 --server_gpu_id 1
