CUDA_VISIBLE_DEVICES=0,1,2 python main.py --task mnist_cnum100_dist1_skew0.2_seed0 --model cnn --algorithm fedavg --num_rounds 50 --num_epochs 5 --learning_rate 0.001 --proportion 0.1 --batch_size 10 --eval_interval 1 --num_threads 2
