...
python main.py --task mnist_cnum100_dist1_skew0.2_seed0 --model cnn --algorithm fedavg --num_rounds 2 --num_epochs 1 --learning_rate 0.001 --proportion 1 --batch_size 10 --eval_interval 1 --gpu 3 --num_threads 1
