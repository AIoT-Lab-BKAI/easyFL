...
GROUP="cifar100_resnet9_clustered_N100_K10"
ALG="journal_v4_cf100"
MODEL="resnet9"
STHR=0.9
EPS=0.5
WANDB=1
...
NUM_GPUS=1
SERVER_GPU_ID=0
TASK="cifar100_resnet9_clustered_N100_K10"
DATA_IDX_FILE="../2023_CCGRID_Hung/easyFL/dataset_idx/cifar/100client/cluster"
