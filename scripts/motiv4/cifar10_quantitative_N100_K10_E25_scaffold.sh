...
#$ -l rt_G.small=1
#$ -l h_rt=36:00:00
#$ -o /home/aaa10078nj/Federated_Learning/Hung_test/logs/motiv4/$JOB_NAME_$JOB_ID.log
#$ -j y
...
LOG_DIR="/home/aaa10078nj/Federated_Learning/Hung_test/logs/motiv4/cifar10/$JOB_NAME_$JOB_ID"
rm -r ${LOG_DIR}
mkdir ${LOG_DIR}
...
GROUP="cifar10_quantitative_N100_K10_E25"
ALG="scaffold"
MODEL="cnn"
WANDB=1
ROUND=200
...
NUM_GPUS=1
SERVER_GPU_ID=0
TASK="cifar10_quantitative_N100_K10_E25"
DATA_IDX_FILE="cifar10/100client/CIFAR10_100client_quantitative.csv"
