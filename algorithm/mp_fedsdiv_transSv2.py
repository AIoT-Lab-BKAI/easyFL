...
class Server(MPBasicServer):
    ...
    def iterate(self, t, pool):
        ...
        final_impact = [sdiv_im * (self.client_vols[cid]/self.data_vol) for (sdiv_im, cid) in zip(self.impact_factor, self.selected_clients)]
        model_diff = self.aggregate(model_diffs, p = final_impact)
    ...
    def update_threshold(self, t):
        self.thr = min(self.thr * (1 + 0.0005)**t, 0.9985)
        return
