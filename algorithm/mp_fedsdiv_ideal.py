...
class Server(MPBasicServer):
    def __init__(self, option, model, clients, test_data=None):
        ...
        # self.impact_factor = [1/int(0.3 * nclient)] * int(0.3 * nclient) + [1/int(0.3 * nclient)] * int(0.3 * nclient) + [1/20] * 20 + [1/10] * 10 + [1/10] * 10
        nclient = len(self.clients)
        self.Q_matrix[0:int(0.3*nclient), 0:int(0.3*nclient)] = 1
        self.Q_matrix[int(0.3*nclient):int(0.6*nclient), int(0.3*nclient):int(0.6*nclient)] = 1
        self.Q_matrix[int(0.6*nclient):int(0.8*nclient),int(0.6*nclient):int(0.8*nclient)] = 1
        self.Q_matrix[int(0.8*nclient):int(0.9*nclient),int(0.8*nclient):int(0.9*nclient)] = 1
        self.Q_matrix[int(0.9*nclient):int(1.0*nclient),int(0.9*nclient):int(1.0*nclient)] = 1
        self.freq_matrix += 1
