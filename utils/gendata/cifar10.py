...
from noniid_quantitative import cifar_noniid_quantitative, cifar100_noniid_quantitative
...
if __name__ == '__main__':
    ...
    print("Gen done!")
    save_dataset_idx(client_dict, f"../../dataset_idx/cifar10/{args.total_client}client/", f"CIFAR10_{args.total_client}client_{args.method}.json")
    ...
    df.to_csv(f"../../dataset_idx/cifar10/{args.total_client}client/CIFAR10_{args.total_client}client_{args.method}.csv", index=False, header=False)
