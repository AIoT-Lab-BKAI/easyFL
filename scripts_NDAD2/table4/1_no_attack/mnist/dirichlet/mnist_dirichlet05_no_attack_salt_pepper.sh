...
#$ -l rt_G.small=1
#$ -l h_rt=36:00:00
#$ -o /home/aaa10078nj/Federated_Learning/Cuong_AttackFL/logs/NDAD2/table4/mnist/$JOB_NAME_$JOB_ID.log
#$ -j y
...
LOG_DIR="/home/aaa10078nj/Federated_Learning/Cuong_AttackFL/logs/NDAD2/table4/mnist/$JOB_NAME_$JOB_ID"
rm -r ${LOG_DIR}
mkdir ${LOG_DIR}
...
GROUP="dirtymnist_dirichlet05_change_num_attacker_salt_pepper"
ALG="mp_fedavg"
MODEL="cnn"
...
SERVER_GPU_ID=0
UNCERTAINTY=0
TASK="dirtymnist_dirichlet01_table4"
IDX_DIR="mnist/dirichlet/mnist_50_clients_dirichlet_01.json"
